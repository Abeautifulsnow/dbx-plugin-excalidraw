...
func (plugin *plugin) Handle(
	...
	case "connection/test":
		...
		return map[string]any{"success": true, "message": "Excalidraw Studio is ready", "connection": connection}, nil
	...
	case "connection/disconnect":
		...
		plugin.mutex.Unlock()
		return map[string]any{"success": true}, nil
	case "dbx-plugin-excalidraw/ping":
		return map[string]any{"ok": true, "plugin": "io.dbx.excalidraw", "language": "go", "connectionId": values["connectionId"]}, nil
	default:
